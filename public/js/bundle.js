	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c() {
				...
				text1 = createText("\n\n    ");
				div0 = createElement("div");
				text2 = createText(ctx.storyText);
				text3 = createText("\n    ");
				...
				h1.className = "svelte-18h45t5";
				div0.className = "storyPage svelte-18h45t5";
				div0.id = "storyEdit";
				div0.contentEditable = true;
				textarea.rows = "4";
				textarea.cols = "50";
				textarea.name = "storyField";
				textarea.id = "storyField";
				...
				button.type = "submit";
				button.className = "svelte-18h45t5";
				div1.className = "edit";
				div2.className = "illustration";
				div3.className = "container -split svelte-18h45t5";
			},
